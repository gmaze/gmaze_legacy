function [hl1,ax2,ax3] = floatAxisY_right(varargin)
...
if exist('subplottag','var')
	allAxes = findall(gcf,'type','axes','tag',subplottag);
else
...
%      set(allAxes(ii),'Position',[ax1Pos(1)+DX ax1Pos(2) ax1Pos(3)-DX ax1Pos(4)])
      set(allAxes(ii),'Position',[ax1Pos(1) ax1Pos(2) ax1Pos(3)-DX ax1Pos(4)])
   else
...
%set(allAxes(1),'Position',[ax1Pos(1)+DX ax1Pos(2) ax1Pos(3)-DX ax1Pos(4)])
set(allAxes(1),'Position',[ax1Pos(1) ax1Pos(2) ax1Pos(3)-DX ax1Pos(4)])
xlimit1 = get(allAxes(1),'Xlim');
...
ax3 = axes('Position',[refPosition(1)+refPosition(3)+DX refPosition(2) 0.01 refPosition(4)]);
